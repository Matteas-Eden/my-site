...
export const Outerstellar = ({ className, close }: ArticleProps) => (
  <article id="outerstellar" className={className} style={{ display: 'none' }}>
    ...
    <p>
      <i>Outerstellar</i> is a top-down arcade space shooter which
      sees the player traverse through multiple levels and attempt to survive
      various waves of enemies. Throughout the game, the player collects coins
      from enemies they have defeated which they can use to upgrade their ship's
      ...
      <br />
      Created in <a href="https://gamemaker.io/en/gamemaker" target="_blank">GameMaker Studio</a> during an <i>Arcade Games Hackathon</i>. Won 2nd place.
    </p>
    <ul
      className="icons"
